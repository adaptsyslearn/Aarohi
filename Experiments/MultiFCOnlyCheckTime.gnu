...
set yrange [0:1.2]
set boxwidth 0.25
set output 'MultiFCCheckTime.eps'

plot \
'PhrasePredictionTimes.dat' using 1:2:($3) w errorbars ls 8 lw 5 pt 2 t "Std. Dev.", \
'PhrasePredictionTimes.dat' using 1:2 w linespoint lt 3 lw 4 pt 6 t "Mean Time"
